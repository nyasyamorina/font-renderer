...
pub const composite_alpha_pre_multiplied_bit_KHR = c.VK_COMPOSITE_ALPHA_PRE_MULTIPLIED_BIT_KHR;
...
pub const structure_type_pipeline_cache_create_info = c.VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO;
...
pub const createPipelineCache = c.vkCreatePipelineCache;
...
pub const destroyPipelineCache = c.vkDestroyPipelineCache;
...
pub const getPipelineCacheData = c.vkGetPipelineCacheData;
